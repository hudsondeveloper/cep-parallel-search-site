      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="sm:col-span-2 md:col-span-2">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>
              CEP Parallel Search
            </h3>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                className="p-2.5 sm:p-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-200"
              >
              ...
              <a
                ...
                className="p-2.5 sm:p-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-200"
              >
                <Book className="w-4 h-4 sm:w-5 sm:h-5 text-slate-400" />
              </a>
            </div>
          </div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs sm:text-sm text-slate-400 hover:text-white transition-colors flex items-center gap-1.5 sm:gap-2"
                >
                  Documentação
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 md:gap-6 text-xs sm:text-sm">
            <span className="px-2 sm:px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20 text-green-300 whitespace-nowrap">
              100% Testado
            </span>
            <span className="px-2 sm:px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 whitespace-nowrap">
              TypeScript
            </span>
            <span className="px-2 sm:px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-300 whitespace-nowrap">
              Node.js 12+
            </span>
          </div>
        </div>
